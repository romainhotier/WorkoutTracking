...
class TestGetWorkshop(unittest.TestCase):
    ...
    def test_id_string_invalid(self):
        ...
        self.assertEqual(response_body.msg, GetWorkshop.msg_badRequest)
        self.assertNotIn("data", response_body)
        self.assertEqual(response_body.detail,
                         GetWorkshopRepBody.detail_expected(param=GetWorkshop.param_id,
    ...
    def test_id_objectId_invalid(self):
        ...
        self.assertEqual(response_body.msg, GetWorkshop.msg_notFound)
        self.assertNotIn("data", response_body)
        self.assertEqual(response_body.detail,
                         GetWorkshopRepBody.detail_expected(param=GetWorkshop.param_id,
